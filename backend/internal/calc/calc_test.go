...
func TestValidation(t *testing.T) {
	...
	groups := map[string][]validationCase{
		...
		"invalid_number": {
			{"three parts", "1.2.3", CodeInvalidNumber, 0, "invalid number at character 1"},
			{"dot before operator", "2.+3", CodeInvalidNumber, 0, "invalid number at character 1"},
			{"later token", "2+1.2.3", CodeInvalidNumber, 2, "invalid number at character 3"},
			{"two dots", "..", CodeInvalidNumber, 0, "invalid number at character 1"},
			{"trailing two dots", "2..", CodeInvalidNumber, 0, "invalid number at character 1"},
			{"decimal trailing dot", "2.5.", CodeInvalidNumber, 0, "invalid number at character 1"},
			{"dot before dropped operator", "2.+", CodeInvalidNumber, 0, "invalid number at character 1"},
			{"dot inside group", "(2.)", CodeInvalidNumber, 1, "invalid number at character 2"},
			{"leading dot trailing dot", ".5.", CodeInvalidNumber, 0, "invalid number at character 1"},
			{"dot then space then number", "2. 3", CodeInvalidNumber, 0, "invalid number at character 1"},
			{"dot before invalid character", "2.$", CodeInvalidNumber, 0, "invalid number at character 1"},
			{"dot before unknown function", "2.x", CodeInvalidNumber, 0, "invalid number at character 1"},
			{"dot before percent", "2.%", CodeInvalidNumber, 0, "invalid number at character 1"},
			{"invalid before invalid character", "1.2.3+$", CodeInvalidNumber, 0, "invalid number at character 1"},
